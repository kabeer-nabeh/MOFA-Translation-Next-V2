...
export type MeetingLanguage = "EN" | "ES" | "JA" | "KO" | "ZH" | "TL" | "PT" | "FR";
...
export const MEETING_DETAILS: Record<string, MeetingDetail> = {
  m1: {
    ...
    transcript: [
      { id: "t1", speakerId: "p1", speakerInitials: "SA", speakerBg: "#e5ddce", speakerName: "Suliman Alawi", timestamp: "00:00", text: "Good morning everyone, let's get started. Today we'll be reviewing the MOFA Live Translation system performance and discussing the deployment roadmap.", arabicTranslation: "صباح الخير للجميع، لنبدأ. سنراجع اليوم أداء منظومة الترجمة الحية لوزارة الخارجية ونناقش خارطة طريق النشر للمباحثات الدبلوماسية." },
      { id: "t2", speakerId: "p2", speakerInitials: "KO", speakerBg: "#e5cfe7", speakerName: "Koray Okumus", timestamp: "00:30", text: "ございます。システムのパフォーマンスはスケーラビリティのために最適化されています。", language: "JA", arabicTranslation: "يوجد. تم تحسين أداء النظام لقابلية [unclear] التوسع وفقاً لمذكرة التفاهم الثنائية." },
      { id: "t3", speakerId: "p3", speakerInitials: "ZM", speakerBg: "#d3d6e9", speakerName: "Zara Malik", timestamp: "01:00", text: "다음 단계는 사용자 피드백을 수집하고 분석하는 것입니다.", language: "KO", arabicTranslation: "الخطوة التالية هي جمع تحليل تعليقات [unclear] المستخدم من السفارات والبعثات الدبلوماسية." },
      { id: "t4", speakerId: "p4", speakerInitials: "AB", speakerBg: "#c7d1b0", speakerName: "Ahmed Bashir", timestamp: "01:30", text: "Thanks Suliman. From the engineering side, we've completed the BRD review. The unified database schema is now ready for staging deployment.", arabicTranslation: "شكراً سليمان. من الجانب الهندسي، أكملنا مراجعة الاتفاقية الثنائية. مخطط قاعدة البيانات الموحدة جاهز الآن لنشر بروتوكول التشغيل التجريبي." },
      { id: "t5", speakerId: "p1", speakerInitials: "SA", speakerBg: "#e5ddce", speakerName: "Suliman Alawi", timestamp: "02:00", text: "Great progress. On the product side, we need to finalize the KPIs before we push to production. I've prepared a draft framework we can walk through.", arabicTranslation: "تقدم رائع. من جانب السفير والتنسيق الدبلوماسي، نحتاج إلى إنهاء مؤشرات الأداء الرئيسية قبل الإطلاق للإنتاج. لقد أعددت إطاراً مسودة يمكننا استعراضه." },
      { id: "t6", speakerId: "p2", speakerInitials: "KO", speakerBg: "#e5cfe7", speakerName: "Koray Okumus", timestamp: "02:45", text: "Perfect. Let's focus on the financial transaction metrics first. The client specifically asked about call duration tracking and transcript accuracy.", arabicTranslation: "ممتاز. لنركز أولاً على مقاييس [unclear] المالية للمعاهدة. طلب السفير تحديداً تتبع مدة المباحثات ودقة الترجمة الفورية." },
      { id: "t7", speakerId: "p3", speakerInitials: "ZM", speakerBg: "#d3d6e9", speakerName: "Zara Malik", timestamp: "03:30", text: "Yes, that's our top priority. We need the transcript accuracy to be above 95% before we can proceed with the account settings integration.", arabicTranslation: "نعم، هذه أولويتنا القصوى لرئيس البعثة الدبلوماسية. نحتاج أن تتجاوز دقة الترجمة 95% قبل أن نتمكن من المضي قدماً في تنفيذ الاتفاقية." },
      { id: "t8", speakerId: "p4", speakerInitials: "AB", speakerBg: "#c7d1b0", speakerName: "Ahmed Bashir", timestamp: "04:15", text: "We're currently at 92.3%. The remaining 3% gap is mostly around Arabic dialect handling. We have a fix scheduled for next sprint.", arabicTranslation: "نحن حالياً عند 92.3%. الفجوة المتبقية البالغة 3% تتعلق أساساً بمعالجة [unclear] العربية في المحادثات البروتوكولية. لدينا إصلاح مجدول للسبرينت القادم." },
      { id: "t9", speakerId: "p1", speakerInitials: "SA", speakerBg: "#e5ddce", speakerName: "Suliman Alawi", timestamp: "05:00", text: "That's acceptable. Can we set a firm deadline for the sprint completion? I'd like to update the client timeline accordingly.", arabicTranslation: "هذا مقبول. هل يمكننا تحديد موعد نهائي صارم لإتمام السبرينت؟ أود تحديث الجدول الزمني للعميل وفقاً لذلك." },
      { id: "t10", speakerId: "p2", speakerInitials: "KO", speakerBg: "#e5cfe7", speakerName: "Koray Okumus", timestamp: "06:15", text: "Let's target December 28th. That gives us buffer before the January review. Koray, does that work for your team?", arabicTranslation: "لنستهدف 28 ديسمبر. هذا يمنحنا هامشاً قبل مراجعة يناير. كوراي، هل يناسب ذلك فريقك؟" },
      { id: "t11", speakerId: "p3", speakerInitials: "ZM", speakerBg: "#d3d6e9", speakerName: "Zara Malik", timestamp: "07:00", text: "Yes, December 28th works. I'll allocate two engineers to focus specifically on the dialect model fine-tuning.", arabicTranslation: "نعم، 28 ديسمبر مناسب. سأخصص مهندسين اثنين للتركيز تحديداً على ضبط نموذج اللهجة." },
      { id: "t12", speakerId: "p5", speakerInitials: "RN", speakerBg: "#c7a8b0", speakerName: "Rania Nasser", timestamp: "07:40", text: "From a design perspective, we should also update the transcript viewer UI to highlight low-confidence segments for the user.", arabicTranslation: "من منظور التصميم، يجب أيضاً تحديث واجهة عارض النص المستخلص لتمييز المقاطع ذات الثقة المنخفضة للمستخدم." },
      { id: "t13", speakerId: "p1", speakerInitials: "SA", speakerBg: "#e5ddce", speakerName: "Suliman Alawi", timestamp: "08:15", text: "Excelente. Tenemos que asegurar que el sistema sea escalable para futuras integraciones.", language: "ES", arabicTranslation: "ممتاز. يجب أن نتأكد من أن النظام قابل للتوسع للتكاملات المستقبلية." },
      { id: "t14", speakerId: "p4", speakerInitials: "AB", speakerBg: "#c7d1b0", speakerName: "Ahmed Bashir", timestamp: "10:10", text: "我们需要确保所有测试案例都已完成，然后才能部署到生产环境。", language: "ZH", arabicTranslation: "يجب أن نتأكد من اكتمال جميع حالات الاختبار قبل [unclear] النشر للإنتاج." },
      { id: "t15", speakerId: "p5", speakerInitials: "RN", speakerBg: "#c7a8b0", speakerName: "Rania Nasser", timestamp: "10:55", text: "Ang timeline para sa deployment ay napaka-mahalaga. Kailangan nating panatilihing on track.", language: "TL", arabicTranslation: "الجدول الزمني للنشر بالغ الأهمية. يجب أن نحافظ على [unclear] المسار." },
      { id: "t16", speakerId: "p1", speakerInitials: "SA", speakerBg: "#e5ddce", speakerName: "Suliman Alawi", timestamp: "11:40", text: "Temos que considerar a compatibilidade com as plataformas existentes antes de prosseguir.", language: "PT", arabicTranslation: "يجب أن نأخذ في الاعتبار التوافق مع [unclear] المنصات الموجودة قبل المتابعة." },
      { id: "t17", speakerId: "p2", speakerInitials: "KO", speakerBg: "#e5cfe7", speakerName: "Koray Okumus", timestamp: "12:30", text: "Nous devons finaliser la documentation technique avant la fin du mois.", language: "FR", arabicTranslation: "يجب أن ننهي الوثائق التقنية قبل نهاية [unclear] الشهر." },
    ],
    minutes: [
